...
},{"./components/Chat.react":158,"react":157}],2:[function(require,module,exports){
...
},{"./FormSection/FormSection.react":159,"./MessagesSection/MessagesSection.react":164,"./UsersSection/UsersSection.react":166,"react":157}],159:[function(require,module,exports){
"use strict";
...
var FormSection = React.createClass({ displayName: "FormSection",
  render: function render() {
    return React.createElement("div", { className: "col-sm-12 chat__form" }, React.createElement("div", { className: "input-group" }, React.createElement("input", { type: "text", className: "form-control", placeholder: "Mesaj" }), React.createElement("span", { className: "input-group-btn" }, React.createElement("button", { className: "btn btn-default", type: "button" }, "Gönder"))));
  }
});
...
},{"./Group.react":160,"react":157}],162:[function(require,module,exports){
"use strict";
...
var MessageItem = React.createClass({ displayName: "MessageItem",
  render: function render() {
    return React.createElement("li", { href: "#", className: "list-group-item" }, React.createElement("h5", { className: "list-group-item-heading" }, this.props.user, ":"), React.createElement("p", { className: "list-group-item-text" }, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta" + " " + "cumque dolorum iure reiciendis sapiente laborum nostrum veritatis" + " " + "saepe totam, non molestias ducimus quidem qui dolore enim fugiat" + " " + "accusamus excepturi pariatur!"));
  }
});
...
var MessagesBox = React.createClass({ displayName: 'MessagesBox',
  ...
  render: function render() {
    return React.createElement('div', { className: 'chat__messages' }, React.createElement('ul', { className: 'list-group' }, React.createElement(MessageItem, { user: 'user 1' }), React.createElement(MessageItem, { user: 'user 2' })));
  }
});

module.exports = MessagesBox;

},{"./Message.react":162,"react":157}],164:[function(require,module,exports){
'use strict';
...
var MessagesSection = React.createClass({ displayName: 'MessagesSection',
  render: function render() {
    return React.createElement('div', { className: 'col-sm-8' }, React.createElement(GroupsBox, null), React.createElement(MessagesBox, { messages: 'Message 1' }));
  }
});

module.exports = MessagesSection;

},{"./Groups.react":161,"./Messages.react":163,"react":157}],165:[function(require,module,exports){
"use strict";
